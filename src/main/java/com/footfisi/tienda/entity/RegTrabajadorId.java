...
/**
 * RegTrabajadorId generated by hbm2java
 */
@Embeddable
public class RegTrabajadorId implements java.io.Serializable {

	private String idTipoDocumento;
	private String vnumeroDocumento;

	public RegTrabajadorId() {
	}

	public RegTrabajadorId(String idTipoDocumento, String vnumeroDocumento) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RegTrabajadorId))
			return false;
		RegTrabajadorId castOther = (RegTrabajadorId) other;
