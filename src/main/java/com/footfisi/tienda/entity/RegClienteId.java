...
/**
 * RegClienteId generated by hbm2java
 */
@Embeddable
public class RegClienteId implements java.io.Serializable {
	...
	public RegClienteId(String idTipoDocumento, String vnumeroDocumento) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RegClienteId))
			return false;
		RegClienteId castOther = (RegClienteId) other;
